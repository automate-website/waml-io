...
public class MoveActionDeserializerIT extends ActionDeserializerBase {

    @Test
    public void moveActionIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream moveAction = getSystemResourceAsStream("./website/automate/waml/jio/in/move-action.yaml");
    ...
    public void moveActionShortNotationIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream moveAction = getSystemResourceAsStream("./website/automate/waml/jio/in/move-action-short-notation.yaml");
        Action action = mapper.readValue(moveAction, Action.class);
    ...
    public void moveActionParentIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream moveAction = getSystemResourceAsStream("./website/automate/waml/jio/in/move-action-parent.yaml");
        Action action = mapper.readValue(moveAction, Action.class);
