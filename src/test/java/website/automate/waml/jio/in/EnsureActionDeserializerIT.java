...
public class EnsureActionDeserializerIT extends ActionDeserializerBase {

    @Test
    public void ensureActionIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream ensureAction = getSystemResourceAsStream("./website/automate/waml/jio/in/ensure-action.yaml");
    ...
    public void ensureActionShortNotationIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream ensureAction = getSystemResourceAsStream("./website/automate/waml/jio/in/ensure-action-short-notation.yaml");
        Action action = mapper.readValue(ensureAction, Action.class);
    ...
    public void ensureActionParentIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream ensureAction = getSystemResourceAsStream("./website/automate/waml/jio/in/ensure-action-parent.yaml");
        Action action = mapper.readValue(ensureAction, Action.class);
