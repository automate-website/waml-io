...
public class ClickActionDeserializerIT extends ActionDeserializerBase {

    @Test
    public void clickActionIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream clickAction = getSystemResourceAsStream("./website/automate/waml/jio/in/click-action.yaml");
    ...
    public void clickActionShortNotationIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream clickAction = getSystemResourceAsStream("./website/automate/waml/jio/in/click-action-short-notation.yaml");
        Action action = mapper.readValue(clickAction, Action.class);
    ...
    public void clickActionParentIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream clickAction = getSystemResourceAsStream("./website/automate/waml/jio/in/click-action-parent.yaml");
        Action action = mapper.readValue(clickAction, Action.class);
