...
public class StoreActionDeserializerIT extends ActionDeserializerBase {

    @Test
    public void storeActionIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream storeAction = getSystemResourceAsStream("./website/automate/waml/jio/in/store-action.yaml");
    ...
    public void storeActionShortNotationIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream storeAction = getSystemResourceAsStream("./website/automate/waml/jio/in/store-action-short-notation.yaml");
        Action action = mapper.readValue(storeAction, Action.class);
