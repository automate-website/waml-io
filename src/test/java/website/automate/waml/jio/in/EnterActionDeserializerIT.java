...
public class EnterActionDeserializerIT extends ActionDeserializerBase {

    @Test
    public void enterActionIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream enterAction = getSystemResourceAsStream("./website/automate/waml/jio/in/enter-action.yaml");
    ...
    public void enterActionShortNotationIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream enterAction = getSystemResourceAsStream("./website/automate/waml/jio/in/enter-action-short-notation.yaml");
        Action action = mapper.readValue(enterAction, Action.class);
    ...
    public void enterActionParentIsDeserialized() throws JsonParseException, JsonMappingException, IOException{
        InputStream enterAction = getSystemResourceAsStream("./website/automate/waml/jio/in/enter-action-parent.yaml");
        Action action = mapper.readValue(enterAction, Action.class);
